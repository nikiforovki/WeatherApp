...
const AppWrapper = styled.div`
  width: 1366px;
  // Удаляем явное задание высоты
  // height: 1042px;
  min-width: 375px;
  max-width: 1366px;
  min-height: 100vh; // Используем min-height для обеспечения минимальной высоты
  max-height: 100vh; // Убираем max-height, так как min-height уже обеспечивает минимальную высоту
  background: transparent linear-gradient(180deg, #20d1bc 0%, #1aade3 100%);
  background-size: cover; // Масштабируем фон так, чтобы он полностью покрывал контейнер
