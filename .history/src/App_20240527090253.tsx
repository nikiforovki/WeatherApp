...
// Обновленное определение AppWrapper с поддержкой темы
const AppWrapper = styled.div`
  ...
  min-height: 100vh;
  background: ${({ theme }) =>
    `linear-gradient(180deg, var(--${theme.primaryColor}) 0%, var(--${theme.secondaryColor}) 100%) 0% 0% no-repeat padding-box`};
