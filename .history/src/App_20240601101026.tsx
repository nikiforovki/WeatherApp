...
const App = () => {
  ...
  return (
    <>
      <ErrorBoundary>
        <GlobalStyles />
        <AppWrapper theme={{ primaryColor: theme === 'light'? '#20d1bc' : '#1aade3', secondaryColor: theme === 'light'? '#1aade3' : '#20d1bc' }}>
          <WeatherHeader />
          <WeatherSummary />
          {isLoading? <WeatherSkeleton count={10} /> : <WeatherForecastDetails />}
        </AppWrapper>
      </ErrorBoundary>
