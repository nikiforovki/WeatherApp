...
const AppWrapper = styled.div`
  width: 100%;
  max-width: 1366px; // Оставляем максимальную ширину, чтобы ограничить ширину контейнера
  min-height: 100vh; // Минимальная высота, равная высоте окна просмотра
  background: transparent linear-gradient(180deg, #20d1bc 0%, #1aade3 100%);
  background-size: cover; // Используем 'cover' для масштабирования фона так, чтобы он полностью покрывал контейнер
