...
const AppWrapper = styled.div`
  ...
  max-width: 1366px;
  background: ${({ theme }) =>
    `linear-gradient(180deg, var(--${theme.palette.type === 'light' ? 'primary-color' : 'secondary-color'}) 0%, var(--${theme.palette.type === 'light' ? 'secondary-color' : 'primary-color'}) 100%) 0% 0% no-repeat padding-box`};
