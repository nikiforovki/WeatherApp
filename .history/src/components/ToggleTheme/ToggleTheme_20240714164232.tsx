...
export const ToggleTheme: React.FC = () => {
  ...
  useEffect(() => {
    ...
    console.log(`Loaded theme from localStorage: ${savedTheme}`); // Логирование для диагностики
    if (savedTheme) {
  ...
  useEffect(() => {
    ...
    console.log(`Saving theme to localStorage: ${themeKey}`); // Логирование для диагностики
  }, [isDarkTheme]);

  useEffect(() => {
    const themeListener = (e: MediaQueryListEvent) => {
      const prefersDark = e.matches;
      console.log(`System theme changed to: ${prefersDark ? 'dark' : 'light'}`); // Логирование для диагностики
      setIsDarkTheme(prefersDark);
    };
  ...
  const handleToggleTheme = () => {
    ...
    console.log(`Toggled theme: ${isDarkTheme ? 'dark' : 'light'}`); // Логирование для диагностики
  };
