...
const StyledSkeletonWeather = styled.div`
  ...
  // /* Базовый стиль */
  // flex-direction: row; /* Элементы располагаются горизонтально по умолчанию */

  @media (max-width: 768px) {
    flex-direction: row;
    flex-direction: column; /* Переключаемся на вертикальное расположение при уменьшении размера до 768px и ниже */
    width: 280px;
    top: 30px;
    left: 10px;
  }
