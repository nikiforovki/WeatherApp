...
const StyledSkeletonWeather = styled.div`
  ...
  left: 71px;
  gap: 24px;
  max-width: 1200px; // Ограничиваем ширину до 1200px
  overflow: hidden;
  ...
  @media (max-width: 375px) {
    max-width: 1200px; // Для мобильных устройств устанавливаем меньшую ширину
    left: 30px;
    top: 500px;
  }

  @media (max-width: 1024px) {
    max-width: 1200px; // Для планшетов устанавливаем промежуточную ширину
    left: 70px;
    top: 900px;
  }
`;
