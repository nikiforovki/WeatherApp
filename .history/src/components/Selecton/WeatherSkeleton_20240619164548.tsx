...
const StyledSkeletonWeather = styled.div`
  ...
  left: 71px;
  gap: 24px;
  width: 100%; // Установите максимальную ширину, если необходимо
  height: auto; // Или установите конкретную высоту, если это подходит для вашего дизайна
  ...
  @media (max-width: 375px) {
    width: 1200px; // Убедитесь, что ширина соответствует вашему дизайну
    left: 30px;
    top: 500px;
  }

  @media (max-width: 1024px) {
    width: 1200px; // Аналогично, проверьте, соответствует ли ширина вашему дизайну
    left: 70px;
    top: 900px;
  }
`;
