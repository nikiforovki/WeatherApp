...
const Dropdown = styled.div`
  ...
  max-height: 200px; /* Максимальная высота для обеспечения прокрутки */
  left: 400px;
`;
...
const CitiesList = styled.ul`
  ...
  max-height: 150px; /* Максимальная высота для обеспечения прокрутки */
  overflow-y: auto; /* Позволяет прокручивать, если содержимое превышает высоту */
`;
...
export const InputSearch: React.FC = () => {
  ...
  const cities = ['Москва', 'Казань', 'Питер']; // Пример списка городов
