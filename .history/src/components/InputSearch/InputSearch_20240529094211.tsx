...
export const InputSearch = () => {
  ...
  const apiError = useSelector((state) => state.apiError); // Предполагается, что у вас есть поле apiError в вашем состоянии
  ...
  useEffect(() => {
    if (apiError && apiError.includes('Город не найден')) {
      alert(apiError); // Можно заменить на более дружественный интерфейс
    }
  }, [apiError]);
