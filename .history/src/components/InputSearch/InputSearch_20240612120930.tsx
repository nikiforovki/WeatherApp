...
export const InputSearch: React.FC = () => {
  ...
  // Объявление handleCityChange до использования
  ...
  useEffect(() => {
    // Использование handleCityChange после ее объявления
    const defaultCity = 'Berlin';
    handleCityChange(defaultCity);
  }, [handleCityChange]); // Теперь ошибки не должно быть, так как handleCityChange объявлена
