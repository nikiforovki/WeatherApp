...
export const InputSearch = () => {
  ...
  const handleCityChange = useCallback(
    (city) => {
      console.log('handleCityChange вызван с:', city);
  ...
  // Используем useEffect для установки значения по умолчанию с задержкой
  useEffect(() => {
    const defaultCity = 'Берлин';
    console.log(`Установка города по умолчанию в ${defaultCity}`);
    // Задержка перед установкой значения по умолчанию
    setTimeout(() => {
