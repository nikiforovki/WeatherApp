...
export const InputSearch: FC = () => {
  ...
  // Убедитесь, что defaultCity присутствует в cities перед вызовом handleCityChange
  useEffect(() => {
    const defaultCity = 'Berlin'; // Замените на город, который гарантированно присутствует в cities
