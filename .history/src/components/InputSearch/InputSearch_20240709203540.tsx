...
const StyledInput = styled.input`
  ...
  @media (min-width: 375px) and (max-width: 768px) {
    width: 90%; /* Можно адаптировать в зависимости от желаемого расположения */
  }

  @media (min-width: 769px) and (max-width: 1024px) {
    width: 80%; /* Можно адаптировать в зависимости от желаемого расположения */
  }

  @media (min-width: 1025px) and (max-width: 1366px) {
    width: 70%; /* Используем проценты для равномерного распределения */
  }

  @media (min-width: 1367px) {
    width: 60%; /* Можно адаптировать в зависимости от желаемого расположения */
  }
`;
