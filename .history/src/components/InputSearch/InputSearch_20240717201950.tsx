...
const SearchContainer = styled.div`
  ...
  width: 100%; /* Настройте исходный дизайн */
  margin-left: 0; /* По умолчанию отступ */
  transition:
    width 0.3s ease,
    margin-left 0.3s ease; /* Эффект перехода */
  z-index: 10;

/* Медиа-запросы с адаптивными корректировками */
@media (min-width: 320px) and (max-width: 359px), (min-width: 360px) and (max-width: 375px), (min-width: 376px) and (max-width: 414px) {
  .element {
    width: 200px;
    margin-left: 10px;
  }
