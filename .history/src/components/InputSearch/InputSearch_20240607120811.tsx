...
export const InputSearch: React.FC = () => {
  ...
  const [hasCities, setHasCities] = useState(false); // Инициализируем hasCities с false
  ...
  useEffect(() => {
    setHasCities(filteredCities.length > 0); // Обновляем hasCities, когда filteredCities меняется
  }, [filteredCities]);
