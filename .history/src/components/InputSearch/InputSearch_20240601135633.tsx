...
export const InputSearch = () => {
  ...
  const errorMessage = useSelector((state) => state.weather.error); // Замените 'yourStateKey' на ключ в вашем Redux store, где хранится сообщение об ошибке
  ...
  const handleKeyPress = (event) => {
    if (event.key === 'Enter') {
      ...
      if (error) {
        alert(error); // Или любой другой способ отображения сообщения об ошибке
      }
    }
  };
