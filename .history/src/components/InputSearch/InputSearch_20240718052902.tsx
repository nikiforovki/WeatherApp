...
width: 100%; /* Изначальная ширина, чтобы она была адаптивной */
  max-width: 912px; /* Максимальная ширина, чтобы она не превышала
  display: flex;
  align-items: center;
  margin-top: 38px;
  margin-left: 71px;
...
width: 100%; /* Изначальная ширина, чтобы она была адаптивной */
  max-width: 912px; /* Максимальная ширина, чтобы она не превышала содержимое */
