...
export const InputSearch: React.FC = () => {
  ...
  useEffect(() => {
    // Установка "Берлин" в поле ввода при монтировании компонента
  ...
  const handleCityChange = useCallback(
    (city: string) => {
      ...
      setShowDropdown(false);
      // Нет необходимости устанавливать inputValue здесь, так как мы передаем город напрямую
    },
    [dispatch], // Убедитесь, что все зависимости актуальны
  );
