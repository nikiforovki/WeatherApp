...
export const InputSearch: React.FC<InputSearchProps> = ({ onCityChange }) => {
  ...
  const [errorMessage, setErrorMessage] = useState<string | null>(null); // Шаг 1: Добавление состояния для ошибки
  ...
  // Шаг 2: Обновление состояния ошибки при выборе города
  useEffect(() => {
  ...
  }, [selectedCity]); // Зависимость от selectedCity
