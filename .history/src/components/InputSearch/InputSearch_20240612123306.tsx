...
import { selectErrorMessage, selectCityNames } from './selectors'; // Предполагается, что эти селекторы определены где-то в вашем проекте
import {
  updateCity,
  fetchCurrentWeatherRequest,
  WORKER_GET_WEATHER_DATA_BY_SEARCH_REQUEST,
} from './actions'; // Предполагается, что эти действия определены где-то в вашем проекте
