...
//   const currentCity = useSelector(selectCurrentCity); // Используем селектор для текущего города
...
//   useEffect(() => {
//     // Автоматический запрос на текущий город при монтировании
//     if (currentCity) {
//       dispatch(updateCity(selectCityNames));
...
//       });
//     }
//   }, [currentCity, dispatch]); // Зависимости: текущий город и dispatch
