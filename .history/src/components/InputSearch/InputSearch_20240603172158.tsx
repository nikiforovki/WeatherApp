...
export const InputSearch: React.FC = () => {
  ...
  const CityCities = useSelector(selectCities);
  console.log('Вывод списка городов', CityCities);

  const selectCityNames = useSelector(selectCityNames);
  console.log('Вывод списка городов', selectCityNames);
