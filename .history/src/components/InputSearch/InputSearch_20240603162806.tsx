...
export const InputSearch: React.FC = () => {
  ...
  const cities = useSelector(selectCities); // Используйте данные из селектора
  console.log('Вывод списка городов', cities);

  // Удалите filteredCities, так как теперь вы работаете с данными из Redux
