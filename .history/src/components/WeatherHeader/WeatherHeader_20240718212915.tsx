...
const Container = styled.div`
  ...
  box-sizing: border-box;
  width: 100%; // Используйте 100% для адаптации под родителя
  max-width: 1356px;

  @media (max-width: 768px) {
    // flex-direction: column; // Комментарий: если вы хотите изменить направление flex-контейнера на столбец при малых размерах экрана
  }
`;
