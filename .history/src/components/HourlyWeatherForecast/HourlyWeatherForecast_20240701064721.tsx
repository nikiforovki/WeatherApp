...
const Container = styled.div`
  // position: fixed;
  top: 400px; // Увеличиваем значение top для базового состояния
  left: 487px;
  display: flex;
  flex-wrap: wrap;
  ...
  @media (max-width: 375px) {
    ...
    // left: 10px;
    margin-left:10px
    // top: 1100px; // Увеличиваем значение top для маленьких экранов
    margin-top: 700px
    padding-top: 40px;
  }
  ...
  @media (max-width: 1024px) {
    ...
    // left: 10px;
    margin-left: -70px;
    // top: 900px; // Увеличиваем значение top для больших экранов

    margin-top: 700px;
    padding-top: 40px;
    // top: 700px; // Увеличиваем значение top для средних экранов
