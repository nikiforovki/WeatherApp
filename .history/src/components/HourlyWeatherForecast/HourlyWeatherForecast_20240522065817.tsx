...
import { selectFirstSixHours } from '../../Redux/slice/currentweatherSlice';
...
const HourlyWeatherForecast: React.FC = () => {
  const firstSixHours = useSelector(selectFirstSixHours);
  console.log(firstSixHours);
  ...
  return (
    <Container>
      {firstSixHours.map((hour: HourlyWeather, index: number) => (
