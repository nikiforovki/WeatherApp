...
const Container = styled.div`
  position: fixed;
  top: 0; // Изменено на 0, чтобы Container начинался с верхней части сайта
  left: 0; // Изменено на 0, чтобы Container начинался с левой стороны сайта
  right: 0; // Изменено на 0, чтобы Container занимал всю ширину сайта
  bottom: 0; // Изменено на 0, чтобы Container занимал всю высоту сайта
  display: flex;
  flex-wrap: wrap;
...
const StyledIconСloudСomputing = styled.div`
  position: absolute; // Изменено на absolute, чтобы позиционировать относительно верхней части сайта
  top: 0; // Изменено на 0, чтобы иконка была на самом верху
  left: 10px;
  width: 59px;
  height: 42px;
`;
