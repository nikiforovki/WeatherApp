...
const HourlyWeatherForecast = () => {
  ...
  const temperatureScale = useSelector((state) => state.temperatureScale); // Получаем масштаб температуры из Redux
  const [forecastData, setForecastData] = useState([]);
  const descriptionIcon = useSelector(selectDescriptionIconHurly);
