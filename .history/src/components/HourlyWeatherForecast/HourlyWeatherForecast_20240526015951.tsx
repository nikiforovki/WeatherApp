...
const HourlyWeatherForecast = () => {
  ...
  const [forecastData, setForecastData] = useState([
    { time: '12 pm', temperature: 20, description: 'clear sky' },
    { time: '1 pm', temperature: 20, description: 'few clouds' },
  ...
  const getWeatherIcon = (description) => {
    switch (description) {
      case 'clear sky':
        return <img src={SunIcon} alt='Clear Sky' />;
      case 'few clouds':
      case 'scattered clouds':
      case 'broken clouds':
        return <img src={WeatherIcon} alt='Cloudy' />;
      case 'shower rain':
      case 'rain':
        return <img src={Snowflake} alt='Rain' />;
      case 'thunderstorm':
        return <img src={WeatherIcon} alt='Thunderstorm' />;
      case 'snow':
        return <img src={Snowflake} alt='Snow' />;
      default:
        return <img src={WeatherIcon} alt='Default' />;
    }
  };
        ...
        <WeatherCard key={index}>
          <StyledBoxText>
            ...
            <StyledIconСloudСomputing>
              {descriptionIcon && getWeatherIcon(item.description)}
            </StyledIconСloudСomputing>
          </StyledBoxText>
        </WeatherCard>
      ))}
