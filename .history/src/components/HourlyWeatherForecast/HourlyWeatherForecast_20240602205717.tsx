...
const HourlyWeatherForecast = () => {
  ...
  // Функция для преобразования эпохи Unix в время
  ...
  const formattedTimes = hourlyData.map((data) => ({
    ...data,
    time: unixTimestampToTime(data.timestamp), // Предполагается, что у каждого элемента есть поле 'timestamp' с эпохой Unix
  }));
