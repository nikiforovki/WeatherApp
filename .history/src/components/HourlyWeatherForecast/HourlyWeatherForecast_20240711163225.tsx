...
const SkeletonWrapper = styled.div`
  ...
  top: 0; /* Скорректировали начальное положение, чтобы оно соответствовало карточкам */
  left: 0; /* Скорректировали начальное положение, чтобы оно соответствовало карточкам */
  display: flex;
  flex-wrap: wrap;
  gap: 24px;
  ...
  @media (max-width: 375px) {
    width: 280px;
    left: 50px; /* Корректировка левого положения для маленьких экранов */
    top: 0; /* Скорректировали начальное положение, чтобы оно соответствовало карточкам */
    gap: 40px; /* Увеличение интервала для меньших экранов */
  }

  @media (max-width: 1024px) {
    width: 280px;
    left: 150px; /* Корректировка левого положения для средних экранов */
    top: 0; /* Скорректировали начальное положение, чтобы оно соответствовало карточкам */
    gap: 40px; /* Увеличение интервала для средних экранов */
  }
`;
