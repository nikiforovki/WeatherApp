...
const SkeletonWrapper = styled.div`
  ...
  @media (max-width: 375px) {
    width: 280px; // Соответствует width в Container при max-width: 375px
    gap: 40px; // Изменено на 40px для соответствия изменению в Container
  }

  @media (max-width: 1024px) {
    width: 500px; // Соответствует width в Container при max-width: 1024px
    gap: 40px; // Изменено на 40px для соответствия изменению в Container
  }
`;
