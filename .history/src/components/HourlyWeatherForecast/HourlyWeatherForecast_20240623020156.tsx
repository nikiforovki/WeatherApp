...
//   console.log('hourlyTempKelvin', hourlyTempKelvin);
//   const hourlyTemp = useSelector(selectHourlyData);
...
//         console.log(`Original Kelvin value: ${temp}`);
//         if (temp > 0) {
//           return temp - 273.15;
//         } else {
//           console.warn('Temperature below freezing point');
//           return 0;
//         }
//       });
//       const temps =
//         temperatureScale === 'C'
//           ? hourlyTempCelsius
//           : hourlyTempCelsius.map((temp) => Math.floor((temp * 9) / 5 + 32));
//       const icons = descriptionIconsHuorly.slice(0, 7);
//       setForecastData(
//         temps.map((temp, index) => ({
//           time: ` ${index + 1}`,
