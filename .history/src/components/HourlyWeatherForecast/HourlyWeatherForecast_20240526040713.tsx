...
const HourlyWeatherForecast = () => {
  ...
  const [forecastData, setForecastData] = useState([
    ...
    { time: '1 pm', temperature: firstSevenTemps[0] },
    { time: '2 pm', temperature: firstSevenTemps[0] },
    { time: '3 pm', temperature: firstSevenTemps[0] },
    { time: '4 pm', temperature: firstSevenTemps[0] },
    { time: '5 pm', temperature: firstSevenTemps[0] },
    { time: '6 pm', temperature: firstSevenTemps[0] },
  ]);
  console.log('1forecastData:', forecastData);
