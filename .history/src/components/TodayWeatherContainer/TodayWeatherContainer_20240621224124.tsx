...
const TodayWeatherContainer: React.FC = () => {
  ...
  useEffect(() => {
    if (weatherData) {
      ...
      // которая должна выполняться после загрузки данных
      console.log('Weather data loaded:', weatherData);
    }
  }, [weatherData]); // Зависимость от weatherData гарантирует, что эффект запускается только после загрузки данных
  ...
  console.log(convertKelvinToCelsius(300)); // Выводит 26
  console.log(convertKelvinToCelsius(310)); // Выводит 36
  console.log(convertKelvinToCelsius(333.75)); // Выводит 60
