...
const TodayWeatherContainer: React.FC = () => {
  ...
  // console.log('Город Новый в компаненте', city);
  ...
  const displayTemperature = () => {
    if (temperatureScale === 'C') {
      ...
      // Если temperatureScale не равен 'C' или 'F', возвращаем температуру в градусах Цельсия по умолчанию
      return Math.floor(TemperatureToday);
    }
  };
  // console.log('Температура сейчас1111', displayTemperature);
