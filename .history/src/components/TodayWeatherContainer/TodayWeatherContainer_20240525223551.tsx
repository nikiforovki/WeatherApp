...
import {selectTemperature} '../../Redux/slice/currentweatherSlice'
...
const TodayWeatherContainer: React.FC = () => {
  ...
  return (
    <Container>
      ...
      <StyledTemperature>Заглушка температуры1</StyledTemperature>
      ...
      <StyledNowTemperature>Заглушка температуры2</StyledNowTemperature>
    </Container>
  );
};
