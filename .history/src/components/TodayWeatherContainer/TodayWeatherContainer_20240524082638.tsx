...
import { selectWeatherIcon } from '../../Redux/slice/currentweatherSlice';
...
const TodayWeatherContainer: React.FC = () => {
  ...
  // Вызываем селектор selectWeatherIcon с текущим состоянием weatherData
  const weatherIcon = useSelector(selectWeatherIcon);

  // Выводим в консоль иконку погоды
