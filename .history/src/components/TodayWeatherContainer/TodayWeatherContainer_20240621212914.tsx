...
const TodayWeatherContainer: React.FC = () => {
  ...
  console.log('1Temperature', TemperatureToday);
  ...
  const convertKelvinToCelsius = (kelvin: number) => {
    // console.log('1Temperature in Kelvin:', TemperatureToday);
    return Math.round(kelvin - 273.15);
  };
  // console.log('2Temperature in Kelvin:', convertKelvinToCelsius);

  const convertCelsiusToFahrenheit = (celsius: number) => {
    console.log('3Temperature in Celsius:', TemperatureToday);
