...
const NowContainer = styled.div`
  ...
  top: 212px;
  left: 504px;
  bottom: 20px .now-element {
    position: absolute;
    z-index: 1000; // Убедитесь, что этот контейнер находится над другими элементами
  }
...
// Компоненты, теперь являющиеся дочерними элементами NowContainer
const StyledNowText = styled.div`
  width: 46px;
  height: 26px;
  font-size: 22px;
