...
//   // console.log('ТемператураСегодня', TemperatureToday);
...
//   // Удаляем условие проверки наличия данных о погоде
//   // const currentTemperature =
//   //   temperatureScale === 'C'
//   //    ? weatherData.current.temp - 273.15
//   //     : weatherData.current.temp;

//   // Возвращаем компонент без условий, связанных с загрузкой данных
//   return (
//     <Container>
...
//       <StyledNowTemperature>{TemperatureToday}</StyledNowTemperature>
//     </Container>
//   );
// };
...
const TodayWeatherContainer: React.FC = () => {
  ...
  if (!weatherData || !weatherData.current || !weatherData.weather) {
    ...
    console.log('11Загрузка данных о погоде...');
  ...
  console.log('Текущая температура:', TemperatureToday);
  ...
  return (
    <Container>
      ...
      <StyledTemperature>{TemperatureToday.toFixed(1)}°</StyledTemperature>
      <StyledMaterialLocation>
        <IconMaterialLocation />
      </StyledMaterialLocation>
      {/* <StyledCyti>
