...
const TodayWeatherContainer: React.FC = () => {
  ...
  const [showError, setShowError] = useState(false); // Добавлено состояние для управления видимостью ошибки
  ...
  if (showError) {
    // Используем состояние showError для управления видимостью ошибки
    return (
