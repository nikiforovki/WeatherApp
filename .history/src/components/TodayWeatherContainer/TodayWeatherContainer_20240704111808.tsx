...
const TodayWeatherContainer: React.FC = () => {
  ...
  const descriptionIcon = useSelector(
    (state: RootState) => state.descriptionIcon,
  );
  const TemperatureToday = useSelector(
    (state: RootState) => state.TemperatureToday,
  );
  const city = useSelector((state: RootState) => state.city);
  const contyryName = useSelector((state: RootState) => state.contyryName);
  ...
  const getWeatherIconUrl = (iconCode: boolean) => {
  ...
  return (
    <Container>
      ...
      <StyledMaterialLocation></StyledMaterialLocation>
      <TemperatureScaleToggle setTemperatureScale={setTemperatureScale} />
    </Container>
  );
};
