...
const TodayWeatherContainer: React.FC = () => {
  ...
  // Удалены функции convertKelvinToCelsius и convertCelsiusToFahrenheit

  const displayTemperature = () => {
    // Теперь просто возвращаем TemperatureToday напрямую
  ...
  return (
    <Container>
      ...
      <StyledTemperature>{displayTemperature()}°K</StyledTemperature>
      ...
      <StyledNowTemperature>{displayTemperature()}°K</StyledNowTemperature>
    </Container>
  );
};
