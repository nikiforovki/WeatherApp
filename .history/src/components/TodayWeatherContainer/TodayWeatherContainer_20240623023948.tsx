...
import { putWeatherData } from '../../Redux/actions/fetchCurrentWeatherRequest';
...
const TodayWeatherContainer: React.FC = () => {
  ...
  useEffect(() => {
    if (currentCity) {
      console.log('Dispatching putWeatherData with city:', currentCity); // Логирование перед dispatch
      dispatch(putWeatherData(currentCity));
    }
  }, [dispatch, currentCity]);
