...
const StyledDateDisplay = styled.div`
  height: 18px;
  padding-top: 6px; // Исправлено опечатку
  margin-left: 140px; // Используется для установки отступа слева
  font-size: 15px;
  color: var(
    --dataToday-text-color,
    #ffffff
  ); // Убедитесь, что переменная --dataToday-text-color определена в глобальных стилях
  white-space: nowrap;
`;
