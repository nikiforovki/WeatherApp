...
import { selectTemperatureScale } from '../../Redux/slice/currentweatherSlice'; // И здесь тоже
...
export const TemperatureScaleToggle = () => {
  ...
  const isActive = useSelector(selectTemperatureScale) === 'C';

  const handleClick = () => {
    dispatch(toggleTemperatureScale(isActive ? 'F' : 'C'));
  };
