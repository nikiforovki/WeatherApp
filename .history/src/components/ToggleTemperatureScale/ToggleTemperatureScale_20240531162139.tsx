...
export const TemperatureScaleToggle = () => {
  ...
  // Assuming you have a selector to get the current temperature based on the scale
  const currentTemperature = useSelector((state) =>
    selectTemperature(state, temperatureScale),
  );
  ...
  if (!temperatureScale || !currentTemperature) {
    return <p>Загрузка...</p>; // Fallback UI while loading
  }
