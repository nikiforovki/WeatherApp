import React, { useState, FC } from 'react'; // Добавлен import для FC
import styled from 'styled-components';
import { useDispatch, useSelector } from 'react-redux';
import { toggleTemperatureScale } from '../../Redux/actions/actions';

// Предполагаем, что у вас есть тип State, который описывает структуру вашего хранилища Redux
interface State {
...
interface CustomButtonProps
  ...
  // Исправлено имя пространства имен
  isCelsius?: boolean;
}
...
export const TemperatureScaleToggle: FC<TemperatureScaleToggleProps> = () => {
  ...
  const handleClick = () => {
    ...
    dispatch(toggleTemperatureScale(newScale)); // Исправлено аргумент для dispatch
  };
