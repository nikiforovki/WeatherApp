...
//     if (error) {
//       // Устанавливаем isLoading в true и показываем ошибку
//       setIsLoading(true);
//       setShowError(true);
//     } else {
//       // Устанавливаем isLoading в false и скрываем ошибку
//       setIsLoading(false);
//       setShowError(false);
//     }
//   }, [error]); // Убедитесь, что error включён в список зависимостей
