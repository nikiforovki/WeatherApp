...
export const WeatherForecastDetails: React.FC = () => {
  ...
  useEffect(() => {
    setIsLoading(true); // Установите isLoading в true перед началом загрузки
    dispatch(fetchWeatherData()); // Предполагается, что fetchWeatherData - это ваш action для загрузки данных
  }, [dispatch]); // Зависимость от dispatch, если ваш action зависит от других значений
