...
export const WeatherForecastDetails: React.FC = () => {
  ...
  const setIsLoading = useSelector((state) => state.isLoading); // Получаем состояние из Redux
  console.log('isLoading', isLoading);
  const setShowError = useSelector((state) => state.showError); // Получаем состояние из Redux
