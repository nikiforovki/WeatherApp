...
export const WeatherForecastDetails: React.FC = () => {
  ...
  // const [isLoading, setIsLoading] = useState(true);
  // console.log('Загрузка1', isLoading);
  // console.log('Загрузка2', setIsLoading);
  // const [isLoading, setIsLoading] = useSelector(
  //   (state) => state.weather.isLoading,
  // );
  // console.log('ЗагрузкаК', isLoading);
...
//       setShowError(true);
//     } else {
//       setIsLoading(true); // Установка состояния загрузки в false после обработки ошибки
//     }
//   }, [dispatch, error]);

//   // Дополнительная логика для управления isLoading, если требуется
//   // Например, если здесь происходят дополнительные асинхронные операции
