  ...
  return (
    <Container>
      {cardsData.map((card, index) => {
        // Предполагаем, что у нас есть объект weatherData с необходимыми данными
        const weatherData = {
          sunrise,
          sunset,
          humidity,
        ...
        // Функция для проверки на undefined
        ...
        return (
          <WeatherCard key={index}>
            ...
            {/* Предполагаем, что у каждой карты есть свойство key */}
          </WeatherCard>
        );
      })}
    </Container>
