...
const Container = styled.div`
  ...
  display: flex;
  flex-wrap: wrap;
  // flex-direction: column; // Изменено здесь
  align-items: center; // Добавлено для центрирования элементов по горизонтали
  top: 613px;
  left: 71px;
  max-width: 1280px;
...
export const WeatherForecastDetails: React.FC = () => {
  ...
  const windSpeedKm = Math.round(windSpeed / 1000);
