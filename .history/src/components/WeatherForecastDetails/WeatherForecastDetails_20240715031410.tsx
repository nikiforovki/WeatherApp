...
export const WeatherForecastDetails: React.FC = () => {
  ...
  const isLoading = useSelector((state) => state.isLoading); // Получаем состояние из Redux
  console.log('isLoading', isLoading);
  // const showError = useSelector((state) => state.showError); // Получаем состояние из Redux
