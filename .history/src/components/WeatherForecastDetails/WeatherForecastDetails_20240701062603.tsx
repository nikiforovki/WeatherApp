...
const Container = styled.div`
  ...
  padding-left: 71px; // Отступ слева для симуляции "left: 71px;"

  @media (max-width: 375px) {
    width: 280px;
    padding-left: 10px; // Изменяем отступ слева для мобильных устройств
  }

  @media (max-width: 1024px) {
    width: 660px;
    padding-left: 71px; // Возвращаем стандартный отступ слева для средних размеров экранов
  }
`;
