...
const SkeletonCard = styled.div`
  position: sticky;
  top: 0; // Убедитесь, что вы указали верное значение для top
  width: 288px;
  height: 146px;
...
const Container = styled.div`
  position: sticky;
  top: 613px; // Убедитесь, что вы указали верное значение для top
  display: flex;
  flex-wrap: wrap;
  margin-left: 71px;
  max-width: 1280px;
...
const StyledLine = styled.div`
  position: sticky;
  top: 510px; // Убедитесь, что вы указали верное значение для top
  left: 0;
  height: 0.5px;
