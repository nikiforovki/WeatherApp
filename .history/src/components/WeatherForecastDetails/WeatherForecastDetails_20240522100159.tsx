...
const StyledText = styled.div`
  position: fixed;
  color: #ffffff; // Исправлено на color
  top: 542px; // Раскомментировано и возможно скорректировано
  left: 71px; // Раскомментировано и возможно скорректировано
  width: 190px;
  height: 31px;
  margin-top: 26px;
`;
    ...
    <Container>
      ...
      {cardsData.map((card, index) => (
        <WeatherCard key={index}>
          ...
          {/* {index === precrationIndex && precration !== undefined && (
            <StyledValue>{precration}%</StyledValue>
          )} */}
