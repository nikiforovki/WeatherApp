...
const AppWrapper = styled.div`
  ...
  max-width: 1366px;
  background: ${({ theme }) =>
    `linear-gradient(180deg, var(--${theme === 'light' ? 'var(--primary-color)' : 'var(--secondary-color)'} 0%, var(--${theme === 'light' ? 'var(--secondary-color)' : 'var(--primary-color)'} 100%) 0% 0% no-repeat padding-box`};
...
const App = () => {
  ...
  const handleLoadingChange = (isLoading: string) => {
