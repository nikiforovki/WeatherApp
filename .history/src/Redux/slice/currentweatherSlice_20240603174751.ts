...
//   (weatherData) => {
//     if (!weatherData || !weatherData.cities[0] || !weatherData.cities[0].name) {
//       return null;
//     }
//     return weatherData.cities[0].name;
//   },
// );
...
//   (state) =>
//     state.weatherData &&
//     state.weatherData.cities &&
//     state.weatherData.cities.length > 0
//       ? state.weatherData.cities[0].name
//       : null,
//   (cityName) => cityName,
// );
export const selectAllCityNames = createSelector(
