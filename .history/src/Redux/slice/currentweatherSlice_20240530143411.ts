...
export const selectCurrentWeather = (state) => state.currentWeather; // Пример селектора
export const selectTemperatureScale = (state) => state.currentWeather.scale; // Предполагаемый селектор для масштаба температуры
