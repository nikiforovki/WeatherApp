...
// export const setTemperatureScale = (scale: boolean) => ({
//   type: SET_TEMPERATURE_SCALE,
//   payload: scale,
// });
export const TOGGLE_TEMPERATURE_SCALE = 'TOGGLE_TEMPERATURE_SCALE';

export const toggleTemperatureScale = (scale) => ({
...
// export const putWeatherData = createAction<{ temperature: number }>(
//   'PUT_WEATHER_DATA',
// );
export const fetchCurrentWeatherSuccess = createAction<{ temperature: number }>(
  'FETCH_CURRENT_WEATHER_SUCCESS',
);
