...
// Функция для определения значений переменных CSS на основе текущей темы
...
const AppWrapper = styled.div`
  ...
  background: ${({ theme }) => {
    ...
    return `linear-gradient(180deg, var(--${themeColors.primaryColor}) 0%, var(--${themeColors.secondaryColor}) 100%) 0% 0% no-repeat padding-box`;
  }};
