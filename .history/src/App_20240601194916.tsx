...
const App = () => {
  ...
  return (
    <>
      <ErrorBoundary
        FallbackComponent={({ error }) => <div>Ошибка: {error.message}</div>}
        onError={(error) => {
          console.error('Error caught by ErrorBoundary:', error);
          // Здесь вы можете добавить логику обработки ошибок, например, показать сообщение об ошибке пользователю
        }}
      >
        <GlobalStyles />
        <AppWrapper
