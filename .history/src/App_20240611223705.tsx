...
import WeatherSkeleton from './components/Selecton/WeatherSkeleton'; // Предполагаю, что это опечатка. Правильный путь должен быть './components/WeatherSkeleton/WeatherSkeleton'
...
const App = () => {
  ...
  const [theme, setTheme] = useState('light'); // Инициализация состояния темы
  ...
  return (
    <>
      ...
      >
        ...
        {isLoading ? (
          <WeatherSkeleton count={10} /> // Убедитесь, что путь к компоненту WeatherSkeleton правильный
        ) : (
